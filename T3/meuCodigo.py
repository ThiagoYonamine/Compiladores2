...
def mapa():
    ...
    # Ignorar espaços em branco e "pular linha" do arquivo
    for i in lmatriz:
        if(i == ' ' or i == '\n'):
            continue
...
class Player():
    ...
    def __init__(self):
        # Posição do mapa na tela x: 110 y: 98
        self.bx = 7
        self.by = 4
        self.x = 110 + (self.bx*64)
        self.y = 98 + (self.by*67)
        self.bloco = ((11*(2*(self.by))) + self.bx*2) # Equação para identificar o bloco em que o jogador esta
