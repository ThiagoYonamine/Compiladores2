...
public interface LaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LaParser#obj_item}.
	 * @param ctx the parse tree
	 */
	void enterObj_item(LaParser.Obj_itemContext ctx);
	/**
	 * Exit a parse tree produced by {@link LaParser#obj_item}.
	 * @param ctx the parse tree
	 */
	void exitObj_item(LaParser.Obj_itemContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link LaParser#tipo_item}.
	 * @param ctx the parse tree
	 */
	void enterTipo_item(LaParser.Tipo_itemContext ctx);
	/**
	 * Exit a parse tree produced by {@link LaParser#tipo_item}.
	 * @param ctx the parse tree
	 */
	void exitTipo_item(LaParser.Tipo_itemContext ctx);
	/**
